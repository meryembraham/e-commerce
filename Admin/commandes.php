...
$num = mysqli_num_rows($query);
    ...
    $total_produit     = $array['total_produit'];
...
?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $nom; ?></td>
                                                    <td><?php echo $tel; ?></td>
                                                    <td><?php echo mb_strimwidth($email, 0, 15, "...") ?></td>
                                                    <td><?php echo $payment; ?></td>
                                                    <td><?php echo $shipping; ?></td>
                                                    <td><?php echo $country; ?></td>
                                                    <td><?php echo $state; ?></td>
                                                    <td><?php echo mb_strimwidth($address, 0, 20, "..."); ?></td>
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right"
                                                                ...
                                                                <a class="dropdown-item"
                                                                    href="
                                                                    modifier_categorie.php?id=<?php echo $id_o; ?>">Edit</a>
                                                                <a class="dropdown-item"
                                                                    href="?id=<?php echo $id_o; ?>">Delete</a>
