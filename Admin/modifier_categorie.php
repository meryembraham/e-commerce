...
function categoryTree($idp,$parent_id = 0, $sub_mark = ''){
    ...
    if($query->num_rows > 0){
        while($row = $query->fetch_assoc()){
            $id_c =$row['id_c'];
            if($idp == $id_c){$selected="selected='selected'";}else{$selected="";}
...
if(isset($_POST['envoyer'])){
    ...
    $sql = "UPDATE `category` SET `libelle_c`='$libelle',`description`='$description',`id_parent`='$id_parent' WHERE id_c=$id";
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea name="description" required id="basic-default-message"
                                                ...
                                                aria-describedby="basic-icon-default-message2"><?php echo $description; ?></textarea>
                                        </div>
                                    </div>
