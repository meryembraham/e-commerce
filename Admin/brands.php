...
$sql = "DELETE FROM `brands` WHERE id_b=$id ";
...
?>
                                            <tr>
                                                <td>
                                                    <img src="uploads/<?php echo $logo; ?>" alt="Product Image"
                                                        style="width: 70px;">
                                                </td>
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right"
                                                            ...
                                                            <a class="dropdown-item"
                                                                href="modifier_brand.php?id=<?php echo $id_b; ?>">
                                                                edit</a>
                                                            <a class="dropdown-item"
                                                                href="?id=<?php echo $id_b; ?>">delete</a>
