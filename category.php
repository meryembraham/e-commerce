...
// 3- Prépararyion de la requete
    ...
    $sql_s = "SELECT * FROM `category` WHERE id_parent=$id";
...
?>
                                            <a class="text-decoration-none text-body text-secondary-hover transition-all d-flex justify-content-between align-items-center"
                                                href="#"><i class="ri-arrow-right-s-line align-bottom ms-n1"></i>
                                                <?php echo $libelle_s ?> <span
                                                    class="text-muted ms-4">(21)</span></a><?php }?>
                                        </li>
...
?>
                                            <div class="form-group form-check mb-0">
                                                ...
                                                <label
                                                    ...
                                                    for="filter-brand-0"><?php echo  $libelle_b  ?> <span
                            ...
                            <div class="card position-relative h-100 card-listing hover-trigger">
                                ...
                                <div class="card-body px-0 text-center">
                                    ...
                                    <a class="mb-0 mx-2 mx-md-4 fs-p link-cover text-decoration-none d-block text-center"
                                        href="./product.html"><?php echo $libelle; ?></a>
